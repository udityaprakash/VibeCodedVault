...
export const TitleBar: React.FC<TitleBarProps> = ({
  ...
  return (
    <header className={`titlebar-drag h-10 w-full bg-obsidian-950/90 border-b border-obsidian-900 flex items-center justify-between px-4 select-none z-50 ${isMac ? 'pl-20' : ''}`}>
      {/* Title Details */}
